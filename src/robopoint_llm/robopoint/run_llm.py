...
tokenizer, model, image_processor, context_len = load_pretrained_model(model_path, model_base, model_name, load_8bit=True)
...
image_path = "robopoint/pic.jpg"
original_image = Image.open(image_path)
image = encode_image(image_path)
prompt = "<image>.\nPoint a location on the table beside the cactus." + text
...
annotated_image, pts, boxes = process_and_visualize_output(output, original_image, output_path="robopoint/annotated_pic.jpg")
